...
const Futures = () => {
  ...
  return (
    <>
      <div className="w-full    bg-[#F2F4F7] lg:flex flex-col px-5  pt-20  ">
        <div className="top flex-row flex items-center justify-between lg:px-33   w-full h-[52px]">
        ...
        <div className="w-full md:overflow-x-auto  overflow flex flex-row justify-center gap-3 lg:pb-5 pb-5 pt-10">
          {futures?.map((item) => {
            return (
              <div
                key={item.id}
              ...
              >
                <img
                  ...
                  alt=""
                />
                <h1 className="lg:text-[20px] text-[16px] text-[#252525] px-10 pt-5">
                  {item.title}
                </h1>
                <div className="flex flex-col w-fit absolute left-8 bottom-30">
                  <span className="text-[24px] text-[#667085] line-through">
                    {item.discount}
                  </span>
                ...
                <div className="flex w-full px-5 pt-2 h-[54px] flex-row justify-between items-center ">
                  ...
                  <div className="flex flex-col w-fit justify-center pt-5 items-center">
                    <span className="text-[34px] text-[#101828]">
                      {item.price}
                    </span>
