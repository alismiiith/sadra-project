const Video = ({item,idx}) => {
    return ( <>
         <div  className="w-full  flex flex-row gap-3 2xl:gap-7 pb-5 px-10">
                          <div  className="lg:w-[40%] min-w-[299px] h-[380px]  shadow-black border-gray-300 border-2 cursor-pointer lg:h-[431px]  bg-[#FFFFFF] rounded-2xl   ">
                        <img className="h-[50%] object-center w-full rounded-t-2xl  bg-cover bg-center object-cover" src={item.image1} alt="" />
                        <h1 className="lg:text-[20px] text-[16px] 2xl:px-12  text-[#252525] pr-5 pt-5">{item.title}</h1>
                        <div className="flex 2xl:px-12  relative w-full px-5 pt-2 h-[54px] flex-row justify-between items-center ">
                            <p className="text-[#667085] lg:text-[16px] text-[14px] ">{item.name}</p>
                        ...
                        <div className="flex  w-full lg:gap-7 gap-4    h-[27px] pt-5 justify-center ">
                            <div className="flex flex-row gap-1 h-10px items-center  w-fit">
                                <i className="fa fa-clock"></i>
                                <p className="lg:text-[14px] text-[12px] text-[#667085]">{item.time}</p>
                            </div>
                            <div className="flex flex-row gap-1 h-10px items-center w-fit">
                    ...
                    <div  className="lg:w-[40%] min-w-[299px] h-[380px]  lg:h-[431px] shadow-black border-gray-300 border-2 cursor-pointer  bg-[#FFFFFF] rounded-2xl   ">
                        ...
                        <div className="flex relative 2xl:px-12  w-full px-5 pt-2 h-[54px] flex-row justify-between items-center ">
                            ...
                            <hr className="hrcolor mt-10 mr-10 w-[80%]" />
                            <div className="flex  w-full lg:gap-7 gap-4    h-[27px] pt-5 justify-evenly px-3">
                            <div className="flex flex-row gap-1 h-10px items-center  w-fit">
                                <i className="fa fa-clock"></i>
                                <p className="lg:text-[14px] text-[12px] text-[#667085]">{item.time}</p>
                            </div>
