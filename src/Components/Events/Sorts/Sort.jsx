const Sort = ({item,idx}) => {
    return ( <>
         <div  className="w-full   lg:px-0  lg:flex-row md:flex-row flex flex-col gap-3 pb-5 px-10">
                        ...
                        <h1 className="lg:text-[20px] text-[16px] text-[#252525] pr-5 pt-5">{item.title}</h1>
                        <div className="flex relative w-full px-5 pt-2 h-[54px] flex-row justify-between items-center ">
                            ...
                            <div className="flex flex-row positionmobile w-fit items-center pt-3 ">
                                ...
                                <span className="text-[16px] text-[#667085]">{item.rating}</span>
                            </div>
                    ...
                    <div  className="lg:w-[376px] md:hidden lg:inline md:min-w-[324px] md:h-[413px] w-[299px] h-[380px]  lg:h-[431px] shadow-black border-gray-300 border-2 cursor-pointer  bg-[#FFFFFF] rounded-2xl   ">
                        ...
                        <div className="flex relative w-full px-5 pt-2 h-[54px] flex-row justify-between items-center ">
                            <p className="text-[#667085] lg:text-[16px] text-[14px]">{item.name}</p>
                            <div className="flex flex-row w-fit positionmobile items-center pt-3 ">
                                <i className="fa fa-star star    "></i>
                                <span className="text-[16px] text-[#667085]">{item.rating}</span>
                            </div>
